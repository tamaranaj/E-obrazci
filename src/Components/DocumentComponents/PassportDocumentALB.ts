...
doc.text(personalInfo.address,80,157)
  ...
  if(personalInfo.parents[1]){
    ...
    doc.rect(23,132.5,4,4)
    doc.text('Други документи неопходни за постапката',31,134)
    doc.text('Dokumente tjera të domoddoshrne për procedurën',31,139)
    doc.line(20,140,190,140)
    doc.line(20,23,20,140)
    doc.line(30,23,30,140)
    doc.line(190,23,190,140)
